...
public class Gwt_jboss implements EntryPoint {
	...
	public void onModuleLoad() {
		final Button sendButton = new Button("Sender");
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				System.out.println("Entrei em sendNameTo em Gwt_jboss 4");
				
				AlunoDTO alunoDTO = new AlunoDTO();
				alunoDTO.setAlunoId(30);
				alunoDTO.setNome("teste");
				alunoDTO.setIdade(2);
				...
				/*greetingService.greetServer(alunoDTO, textToServer,
